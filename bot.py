...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8896623062:AAGHyCs0MbScrkD-gSf9-K-5X8HwwbEn3kQ"   # ← ADD BOT TOKEN
TOKEN = (
...
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "7294948308"))
...
BRAND       = "ʀʙx404 нoѕтιηg ΒOT"
BRAND_VER   = "v2.1"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@RBX404"
UPDATE_CH   = "https://t.me/BlackoutZoneRBX404"
...
PAYMENT_METHODS: Dict[str, Dict[str, Any]] = {
    "bkash":   {"name": "bKash",       "number": "01838372430",         "type": "Send Money",       "tag": "[B]"},
    "nagad":   {"name": "Nagad",       "number": "01732466920",         "type": "Send Money",       "tag": "[N]"},
    "rocket":  {"name": "Rocket",      "number": "00000000000",         "type": "Send Money",       "tag": "[R]"},
    "upay":    {"name": "Upay",        "number": "00000000000",         "type": "Send Money",       "tag": "[U]"},
    "binance": {"name": "Binance Pay", "number": "Binance ID 1261622364","type": "USDT (BEP20/TRC20)","tag": "[BP]"},
